...
if __name__ == '__main__':
    ...
    # 初始化基本配置
    strategy_settings = {}
    strategy_settings['strategy_class'] = ZscoreStrategy
    strategy_settings['vt_symbols'] = ["Y888.DCE", 'P888.DCE']
    strategy_settings['interval'] = Interval.MINUTE
    strategy_settings['start'] = datetime(2019, 1, 1 )
    strategy_settings['end'] = datetime(2019, 6, 30)
    strategy_settings['rates'] = {"Y888.DCE": 3/10000, "P888.DCE": 3/10000}
    strategy_settings['slippages'] = {"Y888.DCE":0.2, "P888.DCE": 0.2}
    strategy_settings['sizes'] = {"Y888.DCE":10, "P888.DCE":10}
    strategy_settings['priceticks'] = {"Y888.DCE":2, "P888.DCE":2}
    strategy_settings['capital'] = 1_000_0
    strategy_settings['collection_names'] = {"Y888.DCE":"Y888", "P888.DCE":"P888"}
    boll_dev_list = [3.5]

    spread_window_list = [100]

    product_pool = list(product(boll_dev_list,spread_window_list))
    ...
    for product in product_pool:
        ...
        boll_dev,spread_window = product

        param_dict['boll_dev'] = boll_dev

        param_dict['spread_window'] = spread_window 
    ...
    result_df.to_csv('Y_P_optimization.csv',index=False)
