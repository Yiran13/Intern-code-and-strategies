...
if __name__ == '__main__':
    ...
    strategy_settings['priceticks'] = {"CU888.SHFE":10, 'NI888.SHFE':10}
    strategy_settings['capital'] = 1_0000_0,
    strategy_settings['collection_names'] = {"CU888.SHFE":"CU888", 'NI888.SHFE':"NI888"}
    ...
    result_df.to_csv('CU_NI_optimization.csv',index=False)