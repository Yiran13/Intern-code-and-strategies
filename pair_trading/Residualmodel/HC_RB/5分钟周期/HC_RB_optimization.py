...
if __name__ == '__main__':
   # 初始化基本配置
    ...
    difference_filter_num_list = [20, 30 ]
    std_window_list = [30,60,90,120,150,180]
    hedge_ratio_window_list = [50,100,150,200,250]
    renew_window_list = [2,4,6,8,10,12,14]
    ...
    # 主要参数池
    product_pool = list(product(short_entry_multiplier_list,difference_filter_num_list,std_window_list,hedge_ratio_window_list,renew_window_list))

    # 完整参数池
    param_list = []
    for product in product_pool:
        param_dict = {}
        short_entry_multiplier,difference_filter_num,std_window,hedge_ratio_window,renew_window = product
        ...
        param_dict['mean_window'] = 30 
        param_dict['hedge_ratio_window'] = hedge_ratio_window
        param_dict['renew_window'] = renew_window
