...
class DynamicResidualModelStrategy(StrategyTemplate):
    ...
    def __init__(
        ...
        self.short_exit_multiplier = -abs(self.entry_multiplier*(1+self.exit_ratio))
        self.long_entry_multiplier =  abs(self.entry_multiplier)
        self.long_exit_multiplier = abs(self.entry_multiplier*(1+self.exit_ratio))
